    ...
    <div className="flex flex-col items-center">
      ...
      <section className="relative min-h-[80vh] flex flex-col justify-center items-center text-center px-6 overflow-hidden w-full">
        ...
        <div className="absolute inset-0 pointer-events-none hidden md:block">
          ...
          <img src="/s-bag.png"     alt="" style={{ position:"absolute", height:"170px", width:"auto", top:"5%",  right:"9%",  transform:"rotate(10deg)"  }} />
          ...
          <img src="/s-cup.png"     alt="" style={{ position:"absolute", height:"190px", width:"auto", top:"26%", right:"1%",  transform:"rotate(-6deg)"  }} />
